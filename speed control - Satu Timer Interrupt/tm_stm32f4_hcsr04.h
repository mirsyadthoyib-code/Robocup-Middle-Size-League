...
//variabel global
extern float jarakKiri;
extern float jarakKanan;
extern float jarakDepan;
extern float jarakBelakang;
extern float jarakKananDepan;
extern float jarakKananBelakang;
extern float jarakKiriDepan;
extern float jarakKiriBelakang;
extern float jarakDepanKiri;
extern float jarakDepanKanan;
