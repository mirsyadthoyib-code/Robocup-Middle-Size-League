...
//tambahan
#define ACTIVATESECMOTOR
#define ACTIVATETHCMOTOR
#define ACTIVATEFOCMOTOR
#define ACTIVATEFICMOTOR
#define ACTIVATESICMOTOR
#define ACTIVATEKICMOTOR
//end of tambahan
...
extern void InitSecondEncoder(TM_RE_t* data);
extern void InitThirdEncoder(TM_RE_t* data);
extern void InitFourthEncoder(TM_RE_t* data);
extern void InitFifthEncoder(TM_RE_t* data);
extern void InitSixthEncoder(TM_RE_t* data);
extern void InitKickerEncoder(TM_RE_t* data);
...
extern TM_RE_Rotate_t SecondGet(TM_RE_t* data);
extern TM_RE_Rotate_t ThirdGet(TM_RE_t* data);
extern TM_RE_Rotate_t FourthGet(TM_RE_t* data);
extern TM_RE_Rotate_t FifthGet(TM_RE_t* data);
extern TM_RE_Rotate_t SixthGet(TM_RE_t* data);
extern TM_RE_Rotate_t KickerGet(TM_RE_t* data);
...
extern void ThirdProcess(void);
extern void FourthProcess(void);
extern void FifthProcess(void);
extern void SixthProcess(void);
extern void KickerProcess(void);
